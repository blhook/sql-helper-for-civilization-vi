...
namespace Test.ORM.Gameplay
{
    ...
    public partial class DeforestationLevels
    {
        [Key]
        [StringLength(2147483647)]
        public string DeforestationType { get; set; }
        ...
        public long MaxDeforestationPercent { get; set; }

        public long DeforestationPointsPerTurn { get; set; }
    }
}
