...
namespace Test.ORM.Gameplay
{
    ...
    public partial class MinorCivBonuses
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public MinorCivBonuses()
        {
            Leaders_XP2 = new HashSet<Leaders_XP2>();
        }

        [Key]
        [StringLength(2147483647)]
        public string MinorCivBonusType { get; set; }
        ...
        public virtual ICollection<Leaders_XP2> Leaders_XP2 { get; set; }
    }
}
